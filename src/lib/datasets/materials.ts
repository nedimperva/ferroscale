import type { MaterialGrade, MetalFamily } from "@/lib/datasets/types";
...
export function getMaterialGradeById(gradeId: string): MaterialGrade | undefined {
  return MATERIAL_GRADES.find((grade) => grade.id === gradeId);
}

export function getMaterialGradesByFamily(familyId: MetalFamily["id"]): MaterialGrade[] {
