...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed: [
      ...
      "Standard structural profiles (IPE, IPN, HEA, HEB, HEM, UPN, UPE, tees) include catalog nominal dimensions h, b, t_w and t_f (mm) in the dataset: the section drawing shows flange width b and depth h from that data (not just the serial number in the name), with t_w/t_f in the spec column; label parsing remains a fallback; manual angles still show leg dimensions on the L sketch",
    ...
    changed_bs: [
      ...
      "Standardni konstrukcijski profili (IPE, IPN, HEA, HEB, HEM, UPN, UPE, T): u skupu podataka su nominalne dimenzije h, b, t_w i t_f (mm); crtež prikazuje širinu prirubnice b i dubinu h iz tih vrijednosti, t_w/t_f u koloni specifikacije; parsiranje oznake kao rezerva; ručni kutnici: kraci na L skici",
