...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed_bs: [
      ...
      "Sazetak rezultata (cipovi) prikazuje kolicinu, cijenu, otpad i PDV (duzina uklonjena sa cipova); napomena za zaokruzivanje i verzija dataseta ostaju kod referenci",
