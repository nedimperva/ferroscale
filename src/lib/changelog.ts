...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed: [
      ...
      "Standard beams and channels show a vertical h = … mm line from the size designation; tees show flange/stem l and thickness t from T a×a×t labels; manual angles show leg dimensions on the L sketch",
    ...
    changed_bs: [
      ...
      "Standardne grede i kanali: vertikalna linija h = … mm iz oznake dimenzije; T-profil: l i t iz oznake T a×a×t; ručni kutnici: kraci na L skici",
