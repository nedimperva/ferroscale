...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed: [
      ...
      "Result header adds a category schematic beside cross-section stats; a 'This calculation' block lists length, quantity, and EN-style profile/size/material notes (deduped from the link list below)",
    ...
    changed_bs: [
      ...
      "Zaglavlje rezultata ima shemu kategorije profila pored presjeka; blok „Ovaj izračun“ prikazuje dužinu, količinu i EN napomene za profil/dimenziju/materijal (bez duplikata u listi linkova ispod)",
