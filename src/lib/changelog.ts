...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed_bs: [
      ...
      "Obračun na telefonu zadržava kartice Težina i Cijena, ali svaka sada prikazuje jedan komad pored svih, iste dvije kolone kao na desktopu. Traka udjela sklopa ima oznake, svaki dio prikazuje težinu po komadu, a kartica Cijena završava strukturom cijene",
    ],
    fixed_bs: [
