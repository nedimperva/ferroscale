...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed_bs: [
      ...
      "Sacuvano ostaje dostupno kao sacuvani izracuni, a rijecnik Sablona je uklonjen iz aktivnih tokova cuvanja i ponovnog otvaranja.",
      "Uporedi ostaje dostupno u navigaciji, uz compare tray vezan za rezultat i akcije u result sheet-u za brzi pristup.",
