...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    added: [
      ...
      "Saved and Projects mobile tabs gain a hero card at the top of the screen: Saved shows the template count, total stored weight and total uses; Projects shows the active project name, parts count, weight chip and cost chip.",
    ...
    changed: [
      ...
      "Mobile bottom tab bar replaced by a hamburger button in the top header that opens a bottom-sheet menu listing Calculator, Saved, Projects, Settings, plus Compare, What's New, Report an issue, and Replay onboarding.",
      ...
      "Floating mobile result bar removed entirely. The calculator tab owns its own live result card; Saved, Projects and Settings are scroll-only on mobile.",
    ],
    added_bs: [
      ...
      "Sabloni i Projekti na mobilnom dobijaju hero karticu na vrhu: Sabloni prikazuju broj sablona, ukupnu tezinu i koliko su koristeni; Projekti prikazuju ime aktivnog projekta, broj dijelova, cip tezine i cip cijene.",
    ...
    changed_bs: [
      ...
      "Donja tab traka na mobilnom zamijenjena hamburger dugmetom u gornjem headeru koje otvara bottom-sheet meni sa Kalkulator, Sabloni, Projekti, Postavke, plus Uporedi, Novosti, Prijavi problem i Pokreni uvod ponovo.",
      ...
      "Floating mobilni result bar potpuno uklonjen. Kalkulator tab ima svoju karticu sa zivim rezultatom; Sabloni, Projekti i Postavke su na mobilnom samo za skroll.",
    ],
  },
  {
    version: "2.6.0",
