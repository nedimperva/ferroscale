...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed: [
      ...
      "Calculator tab reordered into Size, then Length and quantity side by side on larger screens, then unit price when shown inline",
    ...
    changed_bs: [
      ...
      "Kartica kalkulatora: Velicina, zatim Duzina i kolicina u jednom redu na sirem ekranu, zatim jedinicna cijena ako je ukljucena",
      "Uklonjeni uvodni tekstovi ispod polja velicine i napomena o zaokruzivanju u rezultatu",
      "Obrnuti kalkulator rezim kolicine prikazuje ukupnu duzinu sipke u metrima za cijele komade",
