...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed: [
      ...
      "Result header adds a per-profile cross-section schematic (all 20 profile types) beside area/density; a 'This calculation' block lists length, quantity, and EN-style profile/size/material notes (deduped from the link list below)",
    ...
    changed_bs: [
      ...
      "Zaglavlje rezultata ima shemu presjeka po tipu profila (svih 20 tipova) pored površine/gustoće; blok „Ovaj izračun“ prikazuje dužinu, količinu i EN napomene (bez duplikata u listi linkova ispod)",
