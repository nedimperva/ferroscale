...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changed: [
      ...
      "Result header adds a per-profile cross-section schematic (all 20 profile types) beside area/density — technical drawing style (miter joins, light section fill, symmetry axis on beams); a 'This calculation' block lists length, quantity, and EN-style profile/size/material notes (deduped from the link list below)",
    ...
    changed_bs: [
      ...
      "Zaglavlje rezultata ima shemu presjeka po tipu profila (svih 20) pored površine/gustoće — tehnički crtež (ispuna presjeka, oštri uglovi, isprekidana os simetrije na gredama); blok „Ovaj izračun“ prikazuje dužinu, količinu i EN napomene (bez duplikata u listi linkova ispod)",
