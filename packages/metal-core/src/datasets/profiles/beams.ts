...
export const BEAM_PROFILES: StandardProfileDefinition[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    sizes: [
      ...
      { id: "ipn120", label: "IPN 120", areaMm2: 1420, perimeterMm: 439, referenceLabel: "EN 10024" },
      ...
      { id: "ipn320", label: "IPN 320", areaMm2: 7770, perimeterMm: 1122, referenceLabel: "EN 10024" },
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    sizes: [
      ...
      { id: "hem140", label: "HEM 140", areaMm2: 8056, perimeterMm: 857, referenceLabel: "EN 10365" },
      ...
      { id: "hem260", label: "HEM 260", areaMm2: 21960, perimeterMm: 1575, referenceLabel: "EN 10365" },
