...
export const CHANNEL_ANGLE_PROFILES: StandardProfileDefinition[] = [
  ...
  /* ------------------------------------------------------------------ */
  {
    ...
    sizes: [
      ...
      { id: "upe300", label: "UPE 300", areaMm2: 5270, perimeterMm: 955, referenceLabel: "EN 10279" },
      { id: "upe330", label: "UPE 330", areaMm2: 6070, perimeterMm: 1027, referenceLabel: "EN 10279" },
