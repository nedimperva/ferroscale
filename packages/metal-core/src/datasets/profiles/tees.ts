...
export const TEE_PROFILES: StandardProfileDefinition[] = [
  {
    ...
    sizes: mapSizes([
      ...
      { id: "t45x5.5", label: "T 45×45×5.5", areaMm2: 466, perimeterMm: 180, referenceLabel: "EN 10055" },
      ...
      { id: "t70x7", label: "T 70×70×7", areaMm2: 929, perimeterMm: 280, referenceLabel: "EN 10055" },
      { id: "t80x8", label: "T 80×80×8", areaMm2: 1216, perimeterMm: 320, referenceLabel: "EN 10055" },
      { id: "t90x9", label: "T 90×90×9", areaMm2: 1536, perimeterMm: 360, referenceLabel: "EN 10055" },
      { id: "t100x10", label: "T 100×100×10", areaMm2: 1885, perimeterMm: 400, referenceLabel: "EN 10055" },
      { id: "t110x11", label: "T 110×110×11", areaMm2: 2281, perimeterMm: 440, referenceLabel: "EN 10055" },
